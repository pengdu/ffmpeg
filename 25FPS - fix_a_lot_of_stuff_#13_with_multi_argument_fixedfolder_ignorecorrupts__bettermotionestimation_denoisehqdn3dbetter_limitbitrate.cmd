...
set ARGS=%ARGS% -vf                   "setpts=PTS-STARTPTS,yadif=0:-1:0,dejudder=cycle=20,mpdecimate,format=pix_fmts=yuv420p,fps=fps=25,setpts=N/FRAME_RATE/TB-STARTPTS,crop=trunc(in_w/2)*2:trunc(in_h/2)*2,hqdn3d=luma_spatial=8.0"

::adjust length to total length of shorter video.
set ARGS=%ARGS% -shortest

::limiting bitrate
set ARGS=%ARGS% -maxrate              "600k"
set ARGS=%ARGS% -bufsize              "900k"
