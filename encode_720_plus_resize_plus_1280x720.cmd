...
call ffmpeg -threads 8 -i %VIDEO% -g 6 -vsync 2 -async 1 -vf "yadif=0:0:1,crop=in_h*16/9:in_h,scale=1280:720" -c:v libx264 -preset slow -crf 18 -c:a copy -pix_fmt yuv420p %OUTPUT%
