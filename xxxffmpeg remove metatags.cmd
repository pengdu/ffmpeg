...
-pix_fmt   "yuv420p"                                                                   ^
-tune      "zerolatency"                                                               ^
-x264opts  "keyint=4" -g "2" -forced-idr "true"                                        ^
-refs "16" -rc-lookahead "16"                                                          ^
-vsync "1" -af "aresample=async=1:min_hard_comp=0.100000"                              ^
-vf "yadif=0:-1:0,dejudder=cycle=20,mpdecimate,fps=fps=25,setpts=N/FRAME_RATE/TB-STARTPTS,format=pix_fmts=yuv420p"  ^
-qcomp "0.60" -subq "9" -preset "veryslow" -crf "23"                                   ^
%FILE_OUTPUT%
